...
router.get('/productos/bajo-stock', verificarToken, verificarRol(['SuperAdministrador', 'Administrador', 'Gerente']), obtenerProductosParaReposicion);
...
router.post('/productos', verificarToken, verificarRol(['SuperAdministrador', 'Administrador', 'Gerente']), validarProducto, crearProducto);
router.put('/productos/:id', verificarToken, verificarRol(['SuperAdministrador', 'Administrador', 'Gerente']), validarProducto, actualizarProducto);
router.delete('/productos/:id', verificarToken, verificarRol(['SuperAdministrador', 'Administrador', 'Gerente']), eliminarProducto);

// HU10: Activar/desactivar productos en tiempo real
router.patch('/productos/:id/disponibilidad', verificarToken, verificarRol(['SuperAdministrador', 'Administrador', 'Gerente']), cambiarDisponibilidad);

// Actualizar stock (Administrador, Gerente, SuperAdministrador)
router.patch('/productos/:id/stock', verificarToken, verificarRol(['SuperAdministrador', 'Administrador', 'Gerente']), actualizarStock);
